                    ...
                    <div class="community-text" style="order: 2;">
                        ...
                        <div class="architect-cta" style="display: flex; gap: 20px; align-items: center; margin-top: 20px; flex-wrap: wrap;">
                            ...
                            <div style="display: inline-flex; gap: 16px; align-items: center; flex-shrink: 0;">
                                ...
                                <!-- YouTube -->
                                <a href="https://www.youtube.com/@Thenotoriousalpha" target="_blank" rel="noopener" aria-label="YouTube" style="color: var(--text-muted); transition: color 0.3s ease; display: flex; align-items: center; flex-shrink: 0;" onmouseover="this.style.color='var(--primary-color)'" onmouseout="this.style.color='var(--text-muted)'">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" style="display:block; width:24px; height:24px; flex-shrink:0;">

...
Since you are new to WordPress, here is a step-by-step guide to installing and activating your new theme:

## 1. Set Up WordPress Locally
If you haven't already, download and install **Local by Flywheel** (https://localwp.com/). Create a new site within Local. It will automatically install WordPress for you.
